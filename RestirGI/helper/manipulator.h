...
public:
  ...
  //inputs
  void translate(bool* m_keys, float m_cameraStepMove);

  glm::vec3 getCameraPos()
  {
      //XMFLOAT3 ans{ m_pos.x ,m_pos.y ,m_pos.z };
      return m_pos;
  }

  bool getMouseAndMove()
  {
      if (m_moving && mouse) //键盘和鼠标都未移动
      {
          m_moving = true;
          mouse = true;
          return true;
...
protected:
  ...
  bool m_moving = true; // KeyBoard is not moving
  bool mouse = true; //Mouse is not moving
