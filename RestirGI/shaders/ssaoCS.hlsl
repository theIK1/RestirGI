...
Texture2D<float4> prev_radiance_tex : register(t3);
...
static const float4 output_tex_size = float4(960.0f, 540.0f, 1 / 960.0, 1 / 540.0);
	...
	uint3 GroupThreadId : SV_GroupThreadID)
{
    ...
    GbufferData gbuffer = unpack(GbufferDataPacked::from_uint4(asuint(gbuffer_packed)));
