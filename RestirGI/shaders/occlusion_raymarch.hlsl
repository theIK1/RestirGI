struct OcclusionScreenRayMarch {
    ...
    OcclusionScreenRayMarch CopyThis()
    {
        OcclusionScreenRayMarch res;
        res.max_sample_count = max_sample_count;
        ...
        res.use_halfres_depth = use_halfres_depth;
        res.halfres_depth_tex_size = halfres_depth_tex_size;
        res.halfres_depth_tex = halfres_depth_tex;
        res.fullres_depth_tex = fullres_depth_tex;
        res.use_color_bounce = use_color_bounce;
        res.fullres_color_bounce_tex = fullres_color_bounce_tex;
    ...
    OcclusionScreenRayMarch with_color_bounce(Texture2D<float3> _fullres_color_bounce_tex) {
        OcclusionScreenRayMarch res = CopyThis();
